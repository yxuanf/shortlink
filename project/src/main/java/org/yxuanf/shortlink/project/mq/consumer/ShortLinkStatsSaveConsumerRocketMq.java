...
public class ShortLinkStatsSaveConsumerRocketMq implements RocketMQListener<Map<String, String>> {
    ...
    public void actualSaveShortLinkStats(ShortLinkStatsRecordDTO statsRecord) {
        ...
        try {
            ...
            JSONObject localJson = com.alibaba.fastjson2.JSON.parseObject(localeResultStr);
